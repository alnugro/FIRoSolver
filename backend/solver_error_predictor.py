...
class ErrorPredictor:
    ...
    def execute_parallel_error_prediction(self, sat_check):
        ...
        try:
            ...
            if self.gurobi_thread > 0:
                ...
                future_single_gurobi = pool_gurobi.schedule(self.gurobi_error_prediction, args=(sat_check,), timeout=self.timeout)
            ...
            if self.z3_thread > 0:
                ...
                future_single_z3 = pool_z3.schedule(self.z3_error_prediction, args=(sat_check,), timeout=self.timeout)
    ...
    def gurobi_error_prediction(self ,sat_check):
        ...
        if sat_check == False:
            ...
            target_result = gurobi_instance.run_barebone_real(self.gurobi_thread,None)
    ...
    def z3_error_prediction(self,sat_check):
        ...
        satisfiability, h_res_loc ,gain_res_loc= self.z3_instance_creator().run_barebone(self.z3_thread)
