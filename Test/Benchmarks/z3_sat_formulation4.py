...
class FIRFilterZ3:
    ...
    def runsolver(self):
        ...
        for omega in range(len(self.freqx_axis)):
            ...
            filter_upper_pb_coeffs=filter_coeffs
            filter_upper_pb_literalls=filter_literals
            ...
            solver.add(PbLe(filter_upper_pb_pairs, self.freq_upper_lin[omega]))


            
           
            filter_lower_pb_coeffs=filter_coeffs
            filter_lower_pb_literalls=filter_literals
            ...
            if self.freq_lower_lin[omega] < self.ignore_lowerbound_lin:
                #z3 only take pairs
                solver.add(PbGe(filter_lower_pb_pairs, -self.freq_upper_lin[omega]))
            else: solver.add(PbGe(filter_lower_pb_pairs, self.freq_lower_lin[omega]))
