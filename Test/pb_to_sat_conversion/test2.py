...
total_test = 17 # Example number of tests, adjust as needed
failed_test = []
result_test = []
...
for i in range(total_test):
    ...
    random_weights = [random.randint(weight_min, weight_max) or random.randint(1, weight_max) for _ in range(len(random_lits))]
